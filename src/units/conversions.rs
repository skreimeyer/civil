...
impl Table {
    ...
    pub fn new() -> Table {
        ...
        factors.insert(("centimeter of mercury","kilogram per square  meter"),136.0);
        ...
        factors.insert(("cfm (cubic foot per minch )","cubic  centimeter per sec"),472.0);
        ...
        factors.insert(("coulomb per square  centimeter","coulomb per square  meter"),10000.0);
        factors.insert(("coulomb per square  inch","coulomb per square  centimeter"),0.155);
        factors.insert(("coulomb per square  inch","coulomb per square  meter"),1550.0);
        ...
        factors.insert(("cubic foot per minch ( cfm )","cubic  centimeter per sec"),472.0);
        ...
        factors.insert(("electromagnetic unit of capacitance","farad (F)"),1000000000.0);
        ...
        factors.insert(("electrostatic unit of inductance","henry"),898755431000.0);
        ...
        factors.insert(("kilogram per square centimeter","pound per square foot"),2048.0);
        ...
        factors.insert(("kilogram per square mm","kilogram per square meter"),1000000.0);
        ...
        factors.insert(("ounce per square inch","dyne per square centimeter"),4309.0);
        ...
        factors.insert(("pound per cubic inch","kilogram per cubic meter"),27700.0);
        ...
        factors.insert(("revolution per sec per sec","rev per minch per minch"),3600.0);
        factors.insert(("revolution per sec per sec","rev per minch per sec"),60.0);
        ...
        factors.insert(("stone (British) ( medical )","pound (avoirdupois)"),14.0);
        ...
        factors.insert(("teaspoon (UK & metric)","millilitre ( = cubic centimeter = cc)"),5.0);
        ...
        factors.insert(("ton (short) per square foot","kilogram per square meter"),9765.0);
        factors.insert(("ton (short) per square foot","pound per square inch"),2000.0);
        ...
        factors.insert(("weber per square inch","line per square inch"),100000000.0);
        ...
        factors.insert(("year (mean of 4 year period)","second (time)"),31558150.0);
