...
impl Table {
    ...
    pub fn new() -> Table {
        ...
        factors.insert(("abampere","ampere (A)"),10);
        factors.insert(("abcoulomb","coulomb (C)"),10);
        factors.insert(("abfarad","farad (F)"),1000000000);
        factors.insert(("abhenry","henry (H)"),1E-09);
        factors.insert(("abmho","siemen (S)"),1000000000);
        factors.insert(("abohm","ohm ()"),1E-09);
        factors.insert(("abvolt","volt (V)"),1E-08);
        factors.insert(("acre","square  chainch (Gunter's)"),10);
        factors.insert(("acre","square  rod"),160);
        factors.insert(("acre","square  link (Gunter's)"),100000);
        factors.insert(("acre","hectare"),0.4047);
        factors.insert(("acre","square  foot"),43560);
        factors.insert(("acre","square  meter"),4046.873);
        factors.insert(("acre","square  mile"),0.001562);
        factors.insert(("acre","square  yard"),4840);
        factors.insert(("acre-foot","cubic  foot"),43560);
        factors.insert(("acre-foot","gallon"),325900);
        factors.insert(("acre-foot","cubic meter (m³)"),1233.489);
        factors.insert(("ampere-hour","coulomb (C)"),3600);
        ...
        factors.insert(("are","square meter"),100);
        factors.insert(("atmosphere","ton per square  inch"),0.007348);
        factors.insert(("atmosphere","centimeter of mercury"),76);
        ...
        factors.insert(("atmosphere","kilogram per square  meter"),10332);
        ...
        factors.insert(("barrel (US dry)","cubic  inch"),7056);
        factors.insert(("barrel (US dry)","quart (dry)"),105);
        factors.insert(("barrel (oil)","litre (L or l)"),158.9873);
        factors.insert(("barrel (oil)","gallon (oil)"),42);
        factors.insert(("bar","atmosphere"),0.9869);
        factors.insert(("bar","dyne per square  centimeter"),1000000);
        factors.insert(("bar","kilogram per square  meter"),10200);
        factors.insert(("bar","pascal"),100000);
        factors.insert(("bar","kilopascal (kPa)"),100);
        factors.insert(("bar","pound per square  foot"),2089);
        factors.insert(("bar","pound per square  inch"),14.5);
        factors.insert(("biot","ampere (A)"),10);
        factors.insert(("bolt (US cloth)","meter"),36.576);
        factors.insert(("Btu [more Btu convert here]","erg"),10600000000);
        factors.insert(("Btu (39 degF)","joule (J)"),1059.67);
        factors.insert(("Btu per hr (international table)","watt"),0.2930711);
        factors.insert(("bucket (Brit dry)","cubic centimeter"),18180);
        ...
        factors.insert(("bushel","peck"),4);
        factors.insert(("bushel","pint (dry)"),64);
        factors.insert(("bushel","quart (dry)"),32);
        ...
        factors.insert(("calorie (thermo) per square  centimeter  minch","watt per square  meter"),697.3333);
        factors.insert(("calorie","kilowatt-hour ( kWhr )"),1.16E-06);
        factors.insert(("candela per square inch","candela per square  meter"),1550.003);
        ...
        factors.insert(("centare (centiares)","square  meter"),1);
        ...
        factors.insert(("centimeter","millimeter"),10);
        ...
        factors.insert(("centimeter of mercury","kilogram per square  meter"),136);
        factors.insert(("centimeter of mercury","pound per square  foot"),27.85);
        factors.insert(("centimeter of mercury","pound per square  inch ( psi )"),0.1934);
        ...
        factors.insert(("centimeter per sec per sec","foot per sec per sec"),0.03281);
        factors.insert(("centimeter per sec per sec","kilometer per hr per sec"),0.036);
        factors.insert(("centimeter per sec per sec","meter per sec per sec"),0.01);
        factors.insert(("centimeter per sec per sec","mile per hr per sec"),0.02237);
        factors.insert(("centipoise","pascal second (Pa-s)"),0.001);
        factors.insert(("centistoke","meter square  per second"),1E-06);
        factors.insert(("cfm (cubic foot per minch )","cubic  centimeter per sec"),472);
        factors.insert(("chainch","inch"),792);
        ...
        factors.insert(("chainch (surveyor's or Gunter's)","yard"),22);
        ...
        factors.insert(("clo (alternative info source)","kelvinch square  meter per watt"),0.155);
        factors.insert(("clusec","pascal cubic  meter per sec"),1.333224E-06);
        factors.insert(("cord","cord foot"),8);
        factors.insert(("cord","cubic meter"),3.624556);
        factors.insert(("cord foot","cubic  foot"),16);
        factors.insert(("coulomb","statcoulomb"),3000000000);
        factors.insert(("coulomb","faraday"),1.04E-05);
        factors.insert(("coulomb per square  centimeter","coulomb per square  inch"),64.52);
        factors.insert(("coulomb per square  centimeter","coulomb per square  meter"),10000);
        factors.insert(("coulomb per square  inch","coulomb per square  centimeter"),0.155);
        factors.insert(("coulomb per square  inch","coulomb per square  meter"),1550);
        factors.insert(("coulomb per square  meter","coulomb per square  centimeter"),0.0001);
        factors.insert(("coulomb per square  meter","coulomb per square  inch"),0.0006452);
        factors.insert(("cubic centimeter ( cubic centimeter  )","cubic  foot"),3.53E-05);
        factors.insert(("cubic centimeter","cubic  inch"),0.06102374);
        factors.insert(("cubic centimeter","cubic  meter"),1E-06);
        factors.insert(("cubic centimeter","cubic  millimeter"),1000);
        ...
        factors.insert(("cubic foot ( ft3 )","cubic  centimeter"),28320);
        factors.insert(("cubic foot ( foot ^3 )","cubic  inch"),1728);
        ...
        factors.insert(("cubic foot per minch ( cfm )","cubic  centimeter per sec"),472);
        factors.insert(("cubic foot per minch ( ft3 per minch )","gallon per sec"),0.1247);
        ...
        factors.insert(("cubic inch ( cubic inch  )","cubic  centimeter ( cc ) ( to hp)"),16.387);
        ...
        factors.insert(("cubic inch","mil-foot"),106100);
        factors.insert(("cubic inch","pint (US liq)"),0.03463);
        factors.insert(("cubic inch","quart (US liq)"),0.01732);
        factors.insert(("cubic inch per minute","cubic  meter per second"),2.731177E-07);
        factors.insert(("cubic meter ( cubic m )","bushel (dry)"),28.38);
        factors.insert(("cubic meter","cubic centimeter"),1000000);
        factors.insert(("cubic meter","cubic foot"),35.31);
        factors.insert(("cubic meter","cubic inch"),61023);
        factors.insert(("cubic meter","cubic yard"),1.307951);
        factors.insert(("cubic meter","gallon (US liq)"),264.2);
        factors.insert(("cubic meter","litre"),1000);
        factors.insert(("cubic meter","pint (US liq)"),2113);
        factors.insert(("cubic meter","quart (US liq)"),1057);
        factors.insert(("cubic mile","cubic meter"),4168182000);
        factors.insert(("cubic yard ( cubic yd )","cubic cm"),764600);
        factors.insert(("cubic yard ( yd3 )","cubic foot"),27);
        factors.insert(("cubic yard","cubic inch"),46656);
        factors.insert(("cubic yard","cubic meter"),0.7645549);
        factors.insert(("cubic yard","gallon (US liq)"),202);
        ...
        factors.insert(("degree (angle)","second"),3600);
        ...
        factors.insert(("dekagram","gram"),10);
        factors.insert(("dekalitre","litre"),10);
        factors.insert(("dekameter","meter"),10);
        factors.insert(("denier","gram per meter"),0.0001111111);
        factors.insert(("denier","gram per 9000 meter"),1);
        factors.insert(("dioptre","per meter"),1);
        factors.insert(("drachm (fluid) (UK) ( medical )","cubic  meter"),0.003551633);
        ...
        factors.insert(("dyne per square  centimeter","inch of mercury at 0°C"),2.95E-05);
        factors.insert(("dyne per square  centimeter","inch of water at 4°C"),0.0004015);
        ...
        factors.insert(("electromagnetic unit of capacitance","farad (F)"),1000000000);
        factors.insert(("electromagnetic unit of charge","coulomb (C)"),10);
        factors.insert(("electromagnetic unit of current","ampere (A)"),10);
        ...
        factors.insert(("electrostatic unit of charge (franklinch )","coulomb"),3.33564E-10);
        factors.insert(("electrostatic unit of current","ampere"),3.33564E-10);
        factors.insert(("electrostatic unit of inductance","henry"),898755431000);
        factors.insert(("electrostatic unit of potential","volt"),299.7925);
        factors.insert(("electrostatic unit of resistance","ohm"),898755431000);
        factors.insert(("ell","centimeter"),114.3);
        factors.insert(("ell","inch"),45);
        factors.insert(("em (pica)","inch"),0.167);
        factors.insert(("em (pica)","centimeter"),0.4233);
        factors.insert(("erg per sec","dyne-centimeter per sec"),1);
        factors.insert(("erg","Btu"),9.48E-11);
        factors.insert(("erg","dyne-centimeter"),1);
        ...
        factors.insert(("faraday per sec","ampere (absolute)"),96500);
        ...
        factors.insert(("fathom","foot"),6);
        factors.insert(("fathom","shackle"),15);
        ...
        factors.insert(("foot","mil"),12000);
        factors.insert(("foot of water","amosphere"),0.0295);
        factors.insert(("foot of water","inch  of mercury"),0.8826);
        factors.insert(("foot of water","kilogram per square  centimeter"),0.03048);
        ...
        factors.insert(("foot per 100 foot","percent grade"),1);
        ...
        factors.insert(("foot-pound","erg"),13600000);
        ...
        factors.insert(("foot-pound per minch","kilogram -calorie per minch"),0.000324);
        ...
        factors.insert(("foot-pound per sec","kilogram -calorie per minch"),1.01945);
        factors.insert(("foot-pound per sec","watt"),1.355818);
        factors.insert(("footE+04 (second moment of area)","meter to the fourth power"),0.008630975);
        ...
        factors.insert(("furlong","rod"),40);
        factors.insert(("furlong","foot"),660);
        factors.insert(("foot","foot or foot"),1);
        ...
        factors.insert(("gallon (US)","cubic  inch"),231);
        ...
        factors.insert(("gallon (Imperial) of water","pound of water"),10);
        ...
        factors.insert(("gilbert per centimeter","amp-turn per centimeter"),0.7958);
        ...
        factors.insert(("grain ( see medical page )","dram (avoirdupois)"),0.03657143);
        factors.insert(("grain (troy)","grain (avoirdupois)"),1);
        ...
        factors.insert(("gram","carat (metric)"),5);
        ...
        factors.insert(("gram","milligram"),1000);
        ...
        factors.insert(("gram per cubic  centimeter","pound per cubic  foot"),62.43);
        factors.insert(("gram per cubic  centimeter","pound per cubic  inch"),0.03613);
        factors.insert(("gram per cubic  centimeter","pound per mil-foot"),3.41E-07);
        ...
        factors.insert(("gram per litre","part per million"),1000);
        factors.insert(("gram per square  centimeter","pound per square  foot"),2.0481);
        ...
        factors.insert(("gram-centimeter","joule"),980700);
        factors.insert(("gram-centimeter","kilogram -cal"),234000000);
        factors.insert(("gram-centimeter","kilogram -meter"),100000);
        factors.insert(("hand","centimeter"),10.16);
        factors.insert(("hectare (10000 square m)","acre"),2.471);
        factors.insert(("hectare","square  foot"),107600);
        factors.insert(("hectogram","gram"),100);
        factors.insert(("hectolitre","litre"),100);
        factors.insert(("hectometer","meter"),100);
        factors.insert(("hectowatt","watt"),100);
        factors.insert(("henrie","millihenrie"),1000);
        factors.insert(("hogshead (British)","cubic foot"),10.114);
        factors.insert(("hogshead (US)","cubic foot"),8.42184);
        factors.insert(("hogshead (US)","gallon (US)"),63);
        factors.insert(("horsepower","Btu per minch"),42.44);
        factors.insert(("horsepower","foot-lb per minch"),33000);
        factors.insert(("horsepower","foot-lb per sec"),550);
        ...
        factors.insert(("horsepower (boiler)","Btu per hr"),33479);
        factors.insert(("horsepower (boiler)","watt"),9809.5);
        factors.insert(("horsepower (metric)","watt"),735.4988);
        factors.insert(("horsepower (electric)","watt"),746);
        factors.insert(("horsepower (UK)","watt"),745.7);
        factors.insert(("horsepower (water)","watt"),746.043);
        factors.insert(("horsepower-hour","Btu"),2547);
        factors.insert(("horsepower-hour","erg"),26800000000000);
        factors.insert(("horsepower-hour","foot-lb"),1980000);
        factors.insert(("horsepower-hour","gram-calorie"),641190);
        factors.insert(("horsepower-hour","joule"),2684000);
        factors.insert(("horsepower-hour","kilogram -calorie"),641.1);
        factors.insert(("horsepower-hour","kilogram -meter"),273700);
        ...
        factors.insert(("hundredweight (cwt) (long)","pound (lbs)"),112);
        factors.insert(("hundredweight (long)","ton (long)"),0.05);
        factors.insert(("hundredweight (short)","ounce (avoirdupois)"),1600);
        factors.insert(("hundredweight (short)","pound (lbs)"),100);
        ...
        factors.insert(("inch of mercury","kilogram per square  centimeter"),0.03453);
        ...
        factors.insert(("inch of water (at 4ºC)","kilogram per square  centimeter"),0.00254);
        factors.insert(("inch of water (at 4ºC)","ounce per square  inch"),0.5781);
        factors.insert(("inch of water (at 4ºC)","pound per square  foot"),5.204);
        factors.insert(("inch of water (at 4ºC)","pound per square  inch"),0.03613);
        factors.insert(("international ampere","ampere (absolute)"),0.9998);
        factors.insert(("international volt","joule (absolute)"),1.59E-19);
        factors.insert(("international volt","joule"),96540);
        factors.insert(("iron (shoes)","meter"),0.00053);
        factors.insert(("joule","Btu"),0.000948);
        factors.insert(("joule","erg"),10000000);
        ...
        factors.insert(("joule per centimeter","gram"),10200);
        factors.insert(("joule per centimeter","dyne"),10000000);
        factors.insert(("joule per centimeter","joule per meter (newton)"),100);
        factors.insert(("joule","poundal"),723.3);
        factors.insert(("joule","pound"),22.48);
        factors.insert(("kayser","reciprocal meter"),100);
        factors.insert(("kilogram (kilogram )","dyne"),980665);
        factors.insert(("kilogram","gram"),1000);
        ...
        factors.insert(("kilogram per cubic meter","gram per cubic centimeter"),0.001);
        factors.insert(("kilogram per cubic meter","pound per cubic foot"),0.06243);
        factors.insert(("kilogram per cubic meter","pound per cubic inch"),3.61E-05);
        ...
        factors.insert(("kilogram per square centimeter","dyne"),980665);
        ...
        factors.insert(("kilogram per square centimeter","pound per square foot"),2048);
        factors.insert(("kilogram per square centimeter","pound per square inch"),14.22);
        ...
        factors.insert(("kilogram per cubic meter","pound per square foot"),0.2048);
        factors.insert(("kilogram per cubic meter","pound per square inch"),0.00142);
        factors.insert(("kilogram per square mm","kilogram per square meter"),1000000);
        factors.insert(("kilogram-calorie","Btu"),3.968);
        factors.insert(("kilogram-calorie","foot-pound"),3088);
        factors.insert(("kilogram-calorie","hp-hour"),0.00156);
        factors.insert(("kilogram-calorie","joule"),4186);
        ...
        factors.insert(("kilogram-meter","erg"),98000000);
        ...
        factors.insert(("kiloline","maxwell"),1000);
        factors.insert(("kilolitre","litre"),1000);
        factors.insert(("kilometer","astronomical unit"),6.68E-09);
        factors.insert(("kilometer","centimeter"),100000);
        factors.insert(("kilometer","foot"),3280.84);
        factors.insert(("kilometer","inch"),39400);
        factors.insert(("kilometer","light year"),1.06E-13);
        factors.insert(("kilometer","meter"),1000);
        factors.insert(("kilometer","mile"),0.6214);
        factors.insert(("kilometer","millimeter"),1000000);
        factors.insert(("kilometer","yard"),1094);
        ...
        factors.insert(("kilometer per hr per sec","meter per sec per sec"),0.2778);
        ...
        factors.insert(("kilowatt","foot-lb per minch"),44300);
        ...
        factors.insert(("kilowatt","watt"),1000);
        factors.insert(("kilowatt-hour","Btu"),3413);
        factors.insert(("kilowatt-hour","erg"),36000000000000);
        factors.insert(("kilowatt-hour","foot-lb"),2660000);
        factors.insert(("kilowatt-hour","gram-calorie"),859850);
        factors.insert(("kilowatt-hour","horsepower-hour"),1.341);
        factors.insert(("kilowatt-hour","joule"),3600590);
        factors.insert(("kilowatt-hour","kilogram -calorie"),860.5);
        factors.insert(("kilowatt-hour","kilogram -meter"),367000);
        ...
        factors.insert(("knot","foot per hr"),6080);
        factors.insert(("knot","kilometer per hr"),1.8532);
        factors.insert(("knot","nautical mile per hr"),1);
        factors.insert(("knot","statute mile per hr ( mph )"),1.151);
        factors.insert(("knot","yard per hr"),2027);
        ...
        factors.insert(("langley","joule per square  meter"),41840);
        factors.insert(("league","mile (approx)"),3);
        factors.insert(("leaguer","cubic  meter"),0.5773534);
        factors.insert(("light-year","astronomical unit"),63239.7);
        factors.insert(("light-year","mile"),5900000000000);
        factors.insert(("light-year","kilometer"),9460730000000);
        factors.insert(("ligne (buttons)","meter"),0.000635);
        factors.insert(("line per square centimeter","gausse"),1);
        factors.insert(("line per square inch","gause"),0.155);
        factors.insert(("line per square inch","weber per square centimeter"),1.55E-09);
        ...
        factors.insert(("lumen per square foot","foot-candle"),1);
        ...
        factors.insert(("megaline","maxwell"),1000000);
        factors.insert(("megohm","microhm"),1000000000000);
        factors.insert(("megohm","ohm"),1000000);
        factors.insert(("meter","centimeter"),100);
        ...
        factors.insert(("meter","millimeter"),1000);
        ...
        factors.insert(("meter per sec per sec","cm per sec per sec"),100);
        ...
        factors.insert(("meter-kilogram","centimeter -dyne"),98100000);
        factors.insert(("meter-kilogram","centimeter -gram"),100000);
        ...
        factors.insert(("mile (nautical)","meter"),1852);
        factors.insert(("mile (nautical)","mile (statute)"),1.1516);
        factors.insert(("mile (nautical)","yard"),2027);
        factors.insert(("mile (statute)","centimeter"),161000);
        factors.insert(("mile (statute)","foot"),5280);
        factors.insert(("mile (statute)","inch"),63400);
        factors.insert(("mile (statute)","kilometer"),1.609);
        factors.insert(("mile (statute)","meter"),1609);
        factors.insert(("mile (statute)","mile (nautical)"),0.8684);
        factors.insert(("mile (statute)","yard"),1760);
        factors.insert(("mile per hr","centimeter per sec"),44.7);
        factors.insert(("mile per hr","foot per minch"),88);
        ...
        factors.insert(("mile per minch","cm per sec"),2682);
        factors.insert(("mile per minch","foot per sec"),88);
        factors.insert(("mile per minch","km per minch"),1.609);
        factors.insert(("mile per minch","knot per minch"),0.8684);
        factors.insert(("mile per minch","mile per hr"),60);
        factors.insert(("mil-foot","cubic inch"),9.43E-06);
        factors.insert(("millier","kilogram"),1000);
        factors.insert(("millmicron","meter"),1E-09);
        factors.insert(("millibar","pascal"),100);
        ...
        factors.insert(("milligram per litre","part per million"),1);
        ...
        factors.insert(("minim (British)( medical )","cubic centimeter"),0.059192);
        ...
        factors.insert(("minute (angles)","second"),60);
        factors.insert(("morgen","square  meter"),8565.32);
        factors.insert(("minute ( more time unit  )","second"),60);
        factors.insert(("nautical mile (international)","meter"),1852);
        factors.insert(("neper","decibel"),8.686);
        factors.insert(("newton","dyne"),100000);
        ...
        factors.insert(("ohm","microhm"),1000000);
        factors.insert(("ounce ( oz or ozs)","dram"),16);
        ...
        factors.insert(("peck (US)","quart (dry)"),8);
        factors.insert(("pennyweight (troy)","grain"),24);
        ...
        factors.insert(("perm (0degC)","kilogram  per pascal sec square m"),5.72135E-11);
        factors.insert(("perm inch (0degC)","kilogram  per pascal sec m"),1.45322E-12);
        factors.insert(("phot","lux"),10000);
        factors.insert(("pica (printing)","millimeter"),4.217518);
        factors.insert(("pica (computer)","millimeter"),4.233333);
        factors.insert(("pieze","pascal"),1000);
        ...
        factors.insert(("pound ( lb )","dram"),256);
        factors.insert(("pound","dyne"),445000);
        factors.insert(("pound","grain"),7000);
        ...
        factors.insert(("pound (troy)","grain"),5760);
        factors.insert(("pound (troy)","gram"),373.24177);
        factors.insert(("pound (troy)","ounce (avoirdupois)"),13.1657);
        factors.insert(("pound (troy)","ounce (troy)"),12);
        factors.insert(("pound (troy)","pennyweight (troy)"),240);
        ...
        factors.insert(("pound-foot","centimeter -dyne"),13600000);
        factors.insert(("pound-foot","centimeter -gram"),13825);
        factors.insert(("pound-foot","meter-kilogram s"),0.1383);
        factors.insert(("pound force (lbf)","newton"),4.448);
        factors.insert(("pound per cubic foot","gram per cubic centimeter"),0.01602);
        ...
        factors.insert(("pound per cubic inch","kilogram per cubic meter"),27700);
        factors.insert(("pound per cubic inch","pound per cubic foot"),1728);
        ...
        factors.insert(("pound per mil-foot","gm per cubic centimeter"),2310000);
        ...
        factors.insert(("pound per square foot","kilogram per square meter"),4.882428);
        ...
        factors.insert(("pound per square inch (not pound force!)","kilogram per square meter"),703.0696);
        factors.insert(("pound per square inch","pound per square foot"),144);
        factors.insert(("pound per square inch","pascal (Pa)"),6894.757);
        factors.insert(("psi (pounds-force per square inch )","kilopascal (kPa)"),6.894757);
        factors.insert(("quad","joule"),1.055056E+018);
        factors.insert(("quadrant (angle)","degree"),90);
        factors.insert(("quadrant (angle)","minute"),5400);
        factors.insert(("quadrant (angle)","radian"),1.571);
        factors.insert(("quadrant (angle)","second"),324000);
        ...
        factors.insert(("quintal","kilogram"),100);
        factors.insert(("rad (ionising radiation)","gray (Gy)(joule per kilogram )"),0.01);
        factors.insert(("radian","degree"),57.29578);
        factors.insert(("radian","minute"),3438);
        factors.insert(("radian","second"),206000);
        ...
        factors.insert(("radian per sec per sec","revs per minch per minch"),572.9578);
        ...
        factors.insert(("revolution","degree"),360);
        factors.insert(("revolution","quadrant"),4);
        factors.insert(("revolution","radian"),6.283185);
        factors.insert(("revolution per minch (rpm)","degree per sec"),6);
        factors.insert(("revolution per minch","radian per sec"),0.1047198);
        factors.insert(("revolution per minch","revs per sec"),0.01667);
        factors.insert(("revolution per minch per minch","radian per sec per sec"),0.00175);
        factors.insert(("revolution per minch per minch","rev per minch per minch"),0.01667);
        factors.insert(("revolution per minch per minch","rev per sec per sec"),0.000278);
        factors.insert(("revolution per sec","degree per sec"),360);
        factors.insert(("revolution per sec","radian per sec"),6.283);
        factors.insert(("revolution per sec","rev per minch"),60);
        factors.insert(("revolution per sec per sec","radian per sec per sec"),6.283);
        factors.insert(("revolution per sec per sec","rev per minch per minch"),3600);
        factors.insert(("revolution per sec per sec","rev per minch per sec"),60);
        factors.insert(("rhe","per pascal sec"),10);
        ...
        factors.insert(("scruple ( see medical page )","grain"),20);
        ...
        factors.insert(("shake","nanosecond (ns)"),10);
        factors.insert(("slug","kilogram"),14.5939);
        factors.insert(("slug","pound"),32.17);
        factors.insert(("slug per cubic foot","kilogram per cubic meter"),515.3788);
        factors.insert(("slug per foot second","pascal second"),47.88026);
        factors.insert(("span","inch"),9);
        factors.insert(("sphere","steradian"),12.57);
        factors.insert(("square centimeter","circular mil"),197000);
        ...
        factors.insert(("square centimeter","square millimeter"),100);
        factors.insert(("square centimeter","square yard"),0.00012);
        factors.insert(("square foot","acre"),2.3E-05);
        factors.insert(("square foot","circular mil"),183000000);
        factors.insert(("square foot","square cm"),929);
        factors.insert(("square foot","square inch"),144);
        factors.insert(("square foot","square meter"),0.09290304);
        factors.insert(("square foot","square mile"),3.59E-08);
        factors.insert(("square foot","square millimeter"),92900);
        factors.insert(("square foot","square yard"),0.1111);
        factors.insert(("square foot per hour","square m per second"),2.58064E-05);
        factors.insert(("square foot per second","square m per second"),0.09290304);
        factors.insert(("square inch","circular mil"),1270000);
        ...
        factors.insert(("square inch","square mil"),1000000);
        factors.insert(("square inch","square yard"),0.000772);
        factors.insert(("square kilometer","acre"),247.1);
        factors.insert(("square kilometer","square cm"),10000000000);
        factors.insert(("square kilometer","square foot"),10800000);
        factors.insert(("square kilometer","square inch"),1550000000);
        factors.insert(("square kilometer","square meter"),1000000);
        factors.insert(("square kilometer","square mile"),0.3861);
        factors.insert(("square kilometer","square yard"),1200000);
        factors.insert(("square meter","acre"),0.000247);
        factors.insert(("square meter","square centimeter"),10000);
        factors.insert(("square meter","square foot"),10.763915);
        factors.insert(("square meter","square inch"),1550);
        factors.insert(("square meter","square mile"),3.86E-07);
        factors.insert(("square meter","square millimeter"),1000000);
        factors.insert(("square meter","square yard"),1.196);
        factors.insert(("square mile","acre"),640);
        factors.insert(("square mile","square foot"),27900000);
        factors.insert(("square mile","square km"),2.589988);
        factors.insert(("square mile","square meter"),2589988);
        factors.insert(("square mile","square yard"),3100000);
        factors.insert(("square millimeter","circular mil"),1973);
        ...
        factors.insert(("square yard","square cm"),8361);
        factors.insert(("square yard","square foot"),9);
        factors.insert(("square yard","square inch"),1296);
        factors.insert(("square yard","square meter"),0.8361274);
        factors.insert(("square yard","square mile"),3.23E-07);
        factors.insert(("square yard","square millimeter"),836000);
        ...
        factors.insert(("stathenry","henry"),898755431000);
        factors.insert(("statmho","siemen (S)"),1.112649E-12);
        factors.insert(("statohm","ohm"),898755431000);
        factors.insert(("statvolt","volt"),299.7925);
        factors.insert(("stere","cubic  meter"),1);
        factors.insert(("sthene","newton"),1000);
        factors.insert(("stilb","candela per square  meter"),10000);
        factors.insert(("stoke","meter square  per sec"),0.0001);
        factors.insert(("stone (British) ( medical )","pound (avoirdupois)"),14);
        factors.insert(("stone (British)","kilogram"),6.3502936);
        factors.insert(("tablespoon (UK & metric)","millilitre"),15);
        factors.insert(("tablespoon (US)","millilitre"),14.78676);
        factors.insert(("teaspoon (UK & metric)","millilitre ( = cubic centimeter = cc)"),5);
        factors.insert(("teaspoon (US)","cubic centimeter ( = cc )"),4.928922);
        factors.insert(("therm (European)","joule"),105506000);
        factors.insert(("therm (US)","joule"),105480400);
        factors.insert(("thermie","joule"),4185500);
        factors.insert(("thou (mil)","meter"),2.54E-05);
        factors.insert(("ton (long)","kilogram"),1016.047);
        factors.insert(("ton (long)","pound"),2240);
        factors.insert(("ton (long)","ton (short)"),1.12);
        factors.insert(("ton (tonne)(metric)","kilogram"),1000);
        factors.insert(("ton (metric)","pound"),2205);
        factors.insert(("ton (short)","ounce"),32000);
        factors.insert(("ton (short)","kilogram"),907.1847);
        factors.insert(("ton (short)","pound"),2000);
        ...
        factors.insert(("ton (short) per square foot","kilogram per square meter"),9765);
        factors.insert(("ton (short) per square foot","pound per square inch"),2000);
        factors.insert(("ton of water per 24 hour","pound of water per hr"),83.333);
        ...
        factors.insert(("ton refrigeration","btu per hour"),12000);
        ...
        factors.insert(("watt","erg per sec"),10000000);
        ...
        factors.insert(("watt (absolute)","joule per sec"),1);
        factors.insert(("watt hour","joule"),3600);
        factors.insert(("watt-hour","Btu"),3.413);
        factors.insert(("watt-hour","erg"),36000000000);
        factors.insert(("watt-hour","foot-pound"),2656);
        ...
        factors.insert(("weber","maxwell"),100000000);
        factors.insert(("weber","kiloline"),100000);
        factors.insert(("weber per square inch","gausse"),15500000);
        factors.insert(("weber per square inch","line per square inch"),100000000);
        factors.insert(("weber per square inch","weber per square centimeter"),0.155);
        factors.insert(("weber per square inch","weber per square meter"),1550);
        factors.insert(("weber per square meter","gausse"),10000);
        factors.insert(("weber per square meter","line per square inch"),64500);
        factors.insert(("weber per square meter","weber per square centimeter"),0.0001);
        factors.insert(("weber per square meter","weber per square inch"),0.000645);
        factors.insert(("week","day"),7);
        factors.insert(("week","hour"),168);
        factors.insert(("week","minute (time)"),10080);
        factors.insert(("week","month"),0.2299795);
        factors.insert(("week","second"),605000);
        factors.insert(("yard","centimeter"),91.44);
        factors.insert(("yard","fathom"),0.5);
        factors.insert(("yard","foot"),3);
        factors.insert(("yard","inch"),36);
        ...
        factors.insert(("year (mean of 4 year period)","day ( more on time )"),365.25);
        factors.insert(("year (mean of 4 year period)","hour"),8766);
        factors.insert(("year (mean of 4 year period)","minute (time)"),526000);
        factors.insert(("year (mean of 4 year period)","second (time)"),31558150);
